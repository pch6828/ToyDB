...
SRCS_FOR_LIB:=$(SRCDIR)global.cc $(SRCDIR)file.cc $(SRCDIR)table.cc $(SRCDIR)buffer.cc $(SRCDIR)index.cc $(SRCDIR)bplustree.cc $(SRCDIR)skiplist.cc $(SRCDIR)bplustree_iterator.cc $(SRCDIR)skiplist_iterator.cc $(SRCDIR)api.cc
